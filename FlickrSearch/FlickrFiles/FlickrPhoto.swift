...
///# FlickrPhoto:
///# Данные о фотографии, полученной из Flickr: ее миниатюра, изображение и метаданные, такие как ID.
///# Есть также некоторые методы для построения URL-адресов Flickr и некоторые расчеты размера.
